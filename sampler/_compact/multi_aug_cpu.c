...
__declspec(dllexport) void Multi_Sample(double* X, double* Phi, double* Theta, double* XVK, double* XKJ, int V, int K, int J)
{
...
__declspec(dllexport) void Multi_Input(double* X, double* Pro1, double* Pro2, double* X_t_1, double* X_t_2, int V, int J)
{
